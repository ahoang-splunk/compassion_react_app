# Contributing to CompassionSplunkPoc
...
CompassionSplunkPoc uses [prettier](https://github.com/prettier/prettier) to ensure consistent code formatting. It is recommended
